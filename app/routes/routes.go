...
func (_ tUserController) GetAllUsers(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("UserController.GetAllUsers", args).URL
}

func (_ tUserController) InsertUser(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("UserController.InsertUser", args).URL
}
